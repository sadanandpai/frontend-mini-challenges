  ...
  return (
    ...
    { isEditing?    
       (<form onSubmit={handleEditSubmit} > 
          ...
          />
          <motion.button type="submit" className='col' 
           whileHover={{ 
            scale: 1.1, 
      ...
      {
        list.map((ele)=>
        <motion.div className={styles.dis} key={ele}
        whileHover={{ 
          scale: 1.1, 
          textShadow: "0px 0px 8px rgb(255,255,255)",
          boxShadow: "0px 0px 8px rgb(255,255,255)",
          ...
          <motion.button style={{backgroundColor: 'green',borderRadius: '5px' }} onClick={() => handleEditClick(ele)}
           whileHover={{ 
            scale: 1.1, 
            textShadow: "0px 0px 8px rgb(255,255,255)",
            boxShadow: "0px 0px 8px rgb(255,255,255)",
          ...
          >edit</motion.button>
          <motion.button style={{backgroundColor: 'red' ,marginLeft:'10px',borderRadius: '5px' }} onClick={() => handleDeleteClick(ele)}
            whileHover={{ 
              scale: 1.1, 
              textShadow: "0px 0px 8px rgb(255,255,255)",
              boxShadow: "0px 0px 8px rgb(255,255,255)",
