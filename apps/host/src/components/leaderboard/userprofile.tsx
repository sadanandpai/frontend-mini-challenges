...
const ChallengesContainer = ({ challenges }: { challenges: IChallenge[] }) => <div className={"challengesCOntainer"}>
    <h2>
...
const ProfileContainer = ({ userProfileDetails }: { userProfileDetails: LeaderboardEntry }) => <div className={classes.profileDetailsContainer}>
    <div className={classes.profileDetailsContainerLeft}><img src={userProfileDetails.pic} className={classes.userProfileImg} alt={"contributor"} /></div>
...
export const UserProfile = () => {
    ...
    userProfileDetails.contributions.angular && challenges.push(...userProfileDetails.contributions.angular);
    userProfileDetails.contributions.react && challenges.push(...userProfileDetails.contributions.react);
