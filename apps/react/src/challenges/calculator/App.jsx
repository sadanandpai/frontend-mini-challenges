    ...
    return (
        ...
        <div className={styles.calculator__body}>
            <div className={styles.calculator__screen}>
                <div className={styles.calculator__screen__previous}>
                   {equationDisplay()}
                </div>
                <div className={styles.calculator__screen__first}>
                    {result}
                </div>
            </div>
            <div className={styles.calculator__buttons}>
                <button onClick={() => clear()} className={styles.calculator__operator}id="ac">Clear</button>
                <button onClick={() => deleteNumber()} className={styles.calculator__operator}id="del">Del</button>
                <button onClick={() => negative()} className={styles.calculator__operator} id="negative">+-</button>
                <button onClick={() => setOperation('^2')} className={styles.calculator__operator} id="square">x<sup>2</sup></button>
                <button onClick={() => setOperation('^')} className={styles.calculator__operator} id="exponent">x<sup>y</sup></button>
                <button onClick={() => setOperation('√')} className={styles.calculator__operator} id="radical">√</button>
                <button onClick={() => setOperation('/')} className={styles.calculator__operator}>÷</button>
                <button onClick={() => setNumber('7')} className={styles.calculator__button}>7</button>
                <button onClick={() => setNumber('8')} className={styles.calculator__button}>8</button>
                <button onClick={() => setNumber('9')} className={styles.calculator__button}>9</button>
                <button onClick={() => setOperation('-')} className={styles.calculator__operator}>–</button>
                <button onClick={() => setNumber('4')} className={styles.calculator__button}>4</button>
                <button onClick={() => setNumber('5')} className={styles.calculator__button}>5</button>
                <button onClick={() => setNumber('6')} className={styles.calculator__button}>6</button>
                <button onClick={() => setOperation('*')} className={styles.calculator__operator}>*</button>
                <button onClick={() => setNumber('1')} className={styles.calculator__button}>1</button>
                <button onClick={() => setNumber('2')} className={styles.calculator__button}>2</button>
                <button onClick={() => setNumber('3')} className={styles.calculator__button}>3</button>
                <button onClick={() => setOperation('+')} className={styles.calculator__operator}>+</button>
                <button onClick={() => setNumber('0')} className={styles.calculator__button}>0</button>
                <button onClick={() => setNumber('.')} className={styles.calculator__button}>.</button>
                <button onClick={() => calculate()} className={styles.calculator__operator} id="total">=</button>
            </div>
        </div>
        </div>
    )
