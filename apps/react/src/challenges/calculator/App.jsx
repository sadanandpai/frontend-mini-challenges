        ...
        <div class={styles.container}>
            <div className={styles.calculator__body}>
                ...
                <div className={styles.calculator__buttons}>
                    <button onClick={() => clear()} id="ac" className={styles.calculator__operator}>Clear</button>
                    <button onClick={() => deleteNumber()} id="del" className={styles.calculator__operator}>Del</button>
                    ...
                    <button onClick={() => calculate()} id="total" className={styles.calculator__operator}>=</button>
                </div>
            </div>
        </div>
    )
